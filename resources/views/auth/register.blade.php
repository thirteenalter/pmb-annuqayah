            ...
            <div class="w-full lg:w-[60%] p-8 md:p-12 lg:p-14 flex flex-col justify-center bg-white overflow-y-auto">
                <div class="mb-8 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    <div>
                        ...
                        <p class="text-slate-500 mt-1 font-medium text-sm">Isi formulir pendaftaran dengan data yang
                            benar.</p>
                    </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="space-y-1">
                            <label class="text-[11px] font-bold text-slate-400 uppercase tracking-widest ml-1">Nama
                                Lengkap</label>
                        ...
                        <div class="space-y-1">
                            <label class="text-[11px] font-bold text-slate-400 uppercase tracking-widest ml-1">NIK
                                (Sesuai
                                KTP)</label>
                            <div class="relative group">
                                <span
                        ...
                        <div class="space-y-1">
                            <label class="text-[11px] font-bold text-slate-400 uppercase tracking-widest ml-1">Alamat
                                Email</label>
                            <div class="relative group">
                                <span
                        ...
                        <div class="space-y-1">
                            <label class="text-[11px] font-bold text-slate-400 uppercase tracking-widest ml-1">Kata
                                Sandi</label>
                            <div class="relative group">
                                <span
                        ...
                        <div class="space-y-1">
                            <label
                                class="text-[11px] font-bold text-slate-400 uppercase tracking-widest ml-1">Konfirmasi
                                Sandi</label>
                            <div class="relative group">
                                <span
