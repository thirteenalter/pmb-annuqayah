    ...
    <div class="py-12 bg-slate-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-0">
          ...
          <div class="mb-8 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
              ...
              <form action="{{ route('admin.pembayaran') }}" method="GET" class="flex flex-col md:flex-row items-center gap-3">
                  ...
                  <button type="submit" class="w-full md:w-auto px-6 py-2 bg-slate-900 text-white rounded-2xl text-sm font-bold hover:bg-slate-800 transition-colors">
                      Filter
                  </button>

                  {{-- Tombol Reset jika ada filter --}}
                  @if(request('search') || request('wave_id'))
                      <a href="{{ route('admin.pembayaran') }}" class="text-xs font-bold text-red-500 hover:underline">Reset</a>
                  @endif
              </form>
          </div>
